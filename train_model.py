...
# For validation the order doesn't matter, so we'll just read them sequentially.
    ...
    for epoch_i in range(0, epochs):
        ...
        for step, batch in enumerate(tqdm(train_dataloader)):
            ...
            outputs = model(input_ids, attention_mask=attn_mask, decoder_input_ids=decoder_input_ids, labels=labels)
            ...
            if step % sample_every == 0 and not step == 0:
                ...
                sample_outputs = model.generate(input_ids, decoder_start_token_id=tokenizer.pad_token_id, do_sample=True,   
                                    top_k=50, 
                                    max_length = 512,
                                    top_p=0.8, 
